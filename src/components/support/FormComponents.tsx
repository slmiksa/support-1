...
export const ImageUpload = ({
  ...
  return <div className="grid gap-2">
      ...
      <Input id="imageFile" name="imageFile" type="file" accept="image/*" onChange={handleImageChange} className="text-right cursor-pointer border-slate-200 file:text-white bg-slate-50" />
