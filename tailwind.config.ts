	...
	theme: {
		...
		extend: {
			colors: {
				...
				company: {
					DEFAULT: 'var(--company-primary, #15437f)', // الأزرق الأساسي
					light: '#e6f0ff',
					dark: 'var(--company-secondary, #093467)' // الأزرق الداكن للقائمة
				},
				accent: {
			...
			backgroundImage: {
				'gradient-primary': 'linear-gradient(90deg, var(--company-primary, #15437f) 0%, var(--company-secondary, #093467) 100%)',
