	...
	theme: {
		...
		extend: {
			...
			animation: {
				...
				'pulse-support': 'pulse-support 2s infinite',
			...
			backgroundImage: {
				...
				'gradient-modern': 'linear-gradient(109.6deg, rgba(15, 114, 193, 0.8) 11.2%, rgba(30, 58, 138, 0.9) 91.1%)'
			},
			boxShadow: {
				'soft': '0 4px 10px rgba(0, 0, 0, 0.05)',
				'card': '0 10px 15px -3px rgba(15, 114, 193, 0.1)'
			}
		}
	},
